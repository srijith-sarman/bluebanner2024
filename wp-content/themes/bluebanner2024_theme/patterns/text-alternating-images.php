...
<div class="wp-block-group alignfull" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--50)">
	...
	<div class="wp-block-group alignwide">
		...
		<div class="wp-block-group">
			...
			<p class="has-text-align-center"><?php echo esc_html_x( 'We provide a supportive and positive learning experience in which members are empowered to develop communication and leadership skills, resulting in greater self-confidence and personal growth.', 'Sample subheading content', 'twentytwentyfour' ); ?></p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:group -->
		...
		<div class="wp-block-columns alignwide">
			...
			<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:40%">
				...
				<h3 class="wp-block-heading is-style-asterisk"><?php echo esc_html_x( 'Toastmasters Architect App', 'Sample list heading', 'twentytwentyfour' ); ?></h3>
				<!-- /wp:heading -->
			...
			<div class="wp-block-column" style="flex-basis:50%">
				...
				<figure class="wp-block-image size-large is-style-rounded">
					<img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/tm26.jpg" alt="<?php esc_attr_e( 'Tourist taking photo of a building', 'twentytwentyfour' ); ?>" />
				</figure>
				<!-- /wp:image -->
			</div>
			<!-- /wp:column -->
		...
		<div class="wp-block-columns alignwide">
			...
			<div class="wp-block-column" style="flex-basis:50%">
				<!-- wp:image {"aspectRatio":"4/3","scale":"cover","sizeSlug":"large","linkDestination":"none","className":"is-style-rounded"} -->
				<figure class="wp-block-image size-large is-style-rounded">
					<img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/tm36.jpg" alt="<?php esc_attr_e( 'Windows of a building in Nuremberg, Germany', 'twentytwentyfour' ); ?>" />
				</figure>
				<!-- /wp:image -->
			</div>
			<!-- /wp:column -->
			...
			<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:40%">
				<!-- wp:heading {"level":3,"className":"is-style-asterisk"} -->
				<h3 class="wp-block-heading is-style-asterisk"><?php echo esc_html_x( 'Toastmasters Newsletter', 'Sample heading', 'twentytwentyfour' ); ?></h3>
				<!-- /wp:heading -->
				...
				<ul class="is-style-checkmark-list" style="line-height:1.75">
					...
					<!-- wp:list-item -->
					<li><?php echo esc_html_x( 'Case studies.', 'Sample list item', 'twentytwentyfour' ); ?></li>
					<!-- /wp:list-item -->

					<!-- wp:list-item -->
					<li><?php echo esc_html_x( 'Leadership insights.', 'Sample list item', 'twentytwentyfour' ); ?></li>
					<!-- /wp:list-item -->
				</ul>
				<!-- /wp:list -->
			</div>
